...
def classify_images(images_dir, pet_label_dic, model):
    ...
    classified the pet images of dalmatians.
     ...
     Parameters: 
      ...
      pet_label_dic - Results Dictionary with 'key' as image filename and 'value'
    ...
    # Runs classifier function to classify the images classifier function 
       ...
       truth = pet_label_dic[key][0]
       
       match= [0,1]
       if truth in model_label:
           pet_label_dic[key].extend([model_label, match[1]])
       else:
           pet_label_dic[key].extend([model_label,match[0]])